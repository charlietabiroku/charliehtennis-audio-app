...
function App() {
  ...
  return (
    <main className="app-shell">
      ...
      <footer className="control-dock"><div className="quick-actions"><button type="button" onClick={undo}><Icon type="undo" />Undo</button><button type="button" onClick={resetMatch}><Icon type="reset" />Reset</button><button type="button" onClick={callAllLanguages}><Icon type="volume" />3ヶ国語</button></div></footer>
    </main>
  )
}
